const Background = ({ wide }: { wide: boolean }) =>
  wide ? (
    <div className="pointer-events-none absolute inset-y-0 left-0 grid h-screen w-screen grid-cols-1 place-items-center p-5 pt-0 md:grid-cols-8 md:p-0">
    ...
    <div className="pointer-events-none absolute inset-y-0 left-0 grid h-screen w-screen grid-cols-1 place-items-center p-5 pt-0 md:grid-cols-6 md:p-0">
      <div className="hidden h-screen w-full border-r border-dashed border-yellow-400 opacity-100 md:block md:border-solid" />
      <div className="hidden h-screen w-full md:block" />
