...
export const Hero = () => (
  <div className="flex h-full flex-col justify-between md:min-h-[calc(100vh-16rem)]">
    ...
    <div className="flex h-full flex-col justify-between">
      ...
      <article className=" prose prose-zinc h-full px-12 font-mono text-sm text-black dark:prose-invert dark:text-slate-300">
        ...
        real-world problems
        <br />
        &emsp;- revitalize forgotten ideas in AI
        <br />
        &emsp;- create interpretable ML to expand human knowledge
        {/* </p> */}
      </article>
